...
###################################################################
# Script Name	:   swag.sh                                                                                          
# Description	:   Simple script to generate swagger documentation for delta.
# Author       	:   ARG
...
./scripts/swagger/echo-swag/swag init -g delta-build/api/router.go
